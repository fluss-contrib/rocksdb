...
Git tags add a leading `v`; Maven versions do not. For the RocksDB `10.10.1`
baseline, the corresponding examples are:

```text
Snapshot: 10.10.1-fluss-SNAPSHOT
RC tag:   v10.10.1-fluss-1-rc1
RC Maven: 10.10.1-fluss-1-rc1
Tag:      v10.10.1-fluss-1
Maven:    10.10.1-fluss-1
```
