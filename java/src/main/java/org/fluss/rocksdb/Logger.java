 ...
 *
 * <p>
 * A log level can be set using {@link org.fluss.rocksdb.Options} or
 ...
 * {@link org.fluss.rocksdb.InfoLogLevel#ERROR_LEVEL} or
 * {@link org.fluss.rocksdb.InfoLogLevel#FATAL_LEVEL}.
 * </p>
 */
public abstract class Logger extends RocksCallbackObject implements LoggerInterface {
   ...
   * the {@link org.fluss.rocksdb.Options} instance will be used as
   ...
   *
   * <p><strong>Important:</strong> the log level set within
   * the {@link org.fluss.rocksdb.DBOptions} instance will be used
   * as maximum log level of RocksDB.</p>
   *
   * @param dboptions {@link org.fluss.rocksdb.DBOptions} instance.
   *
   * @deprecated Use {@link Logger#Logger(InfoLogLevel)} instead, e.g. {@code new
