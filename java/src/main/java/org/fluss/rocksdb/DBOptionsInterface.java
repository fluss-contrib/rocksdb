...
public interface DBOptionsInterface<T extends DBOptionsInterface<T>> {
   ...
   *     specified database in {@link RocksDB#open(org.fluss.rocksdb.Options, String)} operation
   *     is missing.
   * @return the instance of the current Options
   * @see RocksDB#open(org.fluss.rocksdb.Options, String)
   */
   ...
   * Default: nullptr
   *
   * @param rateLimiter {@link org.fluss.rocksdb.RateLimiter} instance.
   * @return the instance of the current object.
   *
   * @since 3.10.0
   */
   ...
   * @return {@link org.fluss.rocksdb.InfoLogLevel} instance.
   */
