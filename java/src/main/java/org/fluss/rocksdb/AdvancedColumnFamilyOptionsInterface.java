...
public interface AdvancedColumnFamilyOptionsInterface<
   ...
   *     {@link org.fluss.rocksdb.CompressionType} instances.
   *
   * @return the reference to the current options.
   */
  ...
  /**
   * <p>Return the currently set {@link org.fluss.rocksdb.CompressionType}
   * per instances.</p>
   *
   * <p>See: {@link #setCompressionPerLevel(java.util.List)}</p>
   *
   * @return list of {@link org.fluss.rocksdb.CompressionType}
   *     instances.
   */
