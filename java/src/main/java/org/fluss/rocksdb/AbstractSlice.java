 ...
 *   @see org.fluss.rocksdb.Slice
 *   @see org.fluss.rocksdb.DirectSlice
 *
 ...
 *   @see org.fluss.rocksdb.AbstractSlice subclass Objects. When you dispose
 *   the Java @see org.fluss.rocksdb.AbstractComparator subclass, it disposes the
 *   C++ BaseComparatorJniCallback subclass, which in turn destroys the
 *   Java @see org.fluss.rocksdb.AbstractSlice subclass Objects.
 */
public abstract class AbstractSlice<T> extends RocksMutableObject {
   ...
   *   @see org.fluss.rocksdb.AbstractSlice#data0(long)
   */
  public T data() {
