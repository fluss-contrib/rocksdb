...
public class BlockBasedTableConfig extends TableFormatConfig {
   ...
   *
   * @param indexType {@link org.fluss.rocksdb.IndexType} value
   ...
   *
   * @param dataBlockIndexType {@link org.fluss.rocksdb.DataBlockIndexType} value
   * @return the reference to the current option.
   */
   ...
   * Sets
   *
   * @param checksumType {@link org.fluss.rocksdb.ChecksumType} value.
   * @return the reference to the current option.
   */
   ...
   * <p>
   * {@link org.fluss.rocksdb.Cache} should not be disposed before options instances
   * using this cache is disposed.
   * <p>
   * {@link org.fluss.rocksdb.Cache} instance can be re-used in multiple options
   * instances.
   *
   * @param blockCache {@link org.fluss.rocksdb.Cache} Cache java instance
   *     (e.g. LRUCache).
   *
   * @return the reference to the current config.
   */
   ...
   * <p>
   * {@link org.fluss.rocksdb.Filter} should not be closed before options instances
   * using this filter are closed.
   * <p>
   * {@link org.fluss.rocksdb.Filter} instance can be re-used in multiple options
   * instances.
   *
   * @param filterPolicy {@link org.fluss.rocksdb.Filter} Filter Policy java instance.
   * @return the reference to the current config.
   */
   ...
   *
   * @param indexSearchType {@link org.fluss.rocksdb.IndexSearchType} value
   * @return the reference to the current option.
   */
