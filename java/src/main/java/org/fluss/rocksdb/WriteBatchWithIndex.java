...
/**
 * Similar to {@link org.fluss.rocksdb.WriteBatch} but with a binary searchable
 * index built for all the keys inserted.
 * <p>
 * Calling put, merge, remove or putLogData calls the same function
 * as with {@link org.fluss.rocksdb.WriteBatch} whilst also building an index.
 * <p>
...
public class WriteBatchWithIndex extends AbstractWriteBatch {
   ...
   * {@link org.fluss.rocksdb.RocksIteratorInterface#seek(byte[])} to
   ...
   * creating a new Iterator that will use {@link org.fluss.rocksdb.WBWIRocksIterator}
   ...
   *   e.g. {@link org.fluss.rocksdb.RocksDB#newIterator()}
