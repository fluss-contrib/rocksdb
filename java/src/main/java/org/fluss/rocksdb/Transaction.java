...
import static org.fluss.rocksdb.RocksDB.PERFORMANCE_OPTIMIZATION_FOR_A_VERY_SPECIFIC_WORKLOAD;
 ...
 * {@link OptimisticTransactionDB#beginTransaction(org.fluss.rocksdb.WriteOptions)} or
 * {@link TransactionDB#beginTransaction(org.fluss.rocksdb.WriteOptions)}
 *
...
public class Transaction extends RocksObject {
   ...
   * {@link OptimisticTransactionDB#beginTransaction(org.fluss.rocksdb.WriteOptions)}
   * or {@link TransactionDB#beginTransaction(org.fluss.rocksdb.WriteOptions)}
   *
   ...
   *
   * @param readOptions Read options.
   * @param columnFamilyHandles {@link org.fluss.rocksdb.ColumnFamilyHandle}
   *     instances
  ...
  public enum TransactionState {
     ...
     *
     * @return {@link org.fluss.rocksdb.Transaction.TransactionState} instance or null.
