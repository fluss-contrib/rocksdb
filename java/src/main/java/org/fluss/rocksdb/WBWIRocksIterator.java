...
public class WBWIRocksIterator
   ...
   * {@link org.fluss.rocksdb.WBWIRocksIterator#entry()}
   *
   * It is worth noting that a WriteEntry with
   * the type {@link org.fluss.rocksdb.WBWIRocksIterator.WriteType#DELETE}
   * or {@link org.fluss.rocksdb.WBWIRocksIterator.WriteType#LOG}
  ...
  public static class WriteEntry implements AutoCloseable {
     ...
     * by calling {@link org.fluss.rocksdb.WBWIRocksIterator#entry()}
     */
    private WriteEntry() {
      key = new DirectSlice();
