...
public class WBWIRocksIterator
   ...
   * {@link io.github.fluss_contrib.rocksdb.WBWIRocksIterator#entry()}
   *
   * It is worth noting that a WriteEntry with
   * the type {@link io.github.fluss_contrib.rocksdb.WBWIRocksIterator.WriteType#DELETE}
   * or {@link io.github.fluss_contrib.rocksdb.WBWIRocksIterator.WriteType#LOG}
  ...
  public static class WriteEntry implements AutoCloseable {
     ...
     * by calling {@link io.github.fluss_contrib.rocksdb.WBWIRocksIterator#entry()}
     */
    private WriteEntry() {
      key = new DirectSlice();
