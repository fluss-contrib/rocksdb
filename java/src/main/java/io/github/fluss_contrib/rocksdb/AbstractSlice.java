 ...
 *   @see io.github.fluss_contrib.rocksdb.Slice
 *   @see io.github.fluss_contrib.rocksdb.DirectSlice
 *
 ...
 *   @see io.github.fluss_contrib.rocksdb.AbstractSlice subclass Objects. When you dispose
 *   the Java @see io.github.fluss_contrib.rocksdb.AbstractComparator subclass, it disposes the
 *   C++ BaseComparatorJniCallback subclass, which in turn destroys the
 *   Java @see io.github.fluss_contrib.rocksdb.AbstractSlice subclass Objects.
 */
public abstract class AbstractSlice<T> extends RocksMutableObject {
   ...
   *   @see io.github.fluss_contrib.rocksdb.AbstractSlice#data0(long)
   */
  public T data() {
