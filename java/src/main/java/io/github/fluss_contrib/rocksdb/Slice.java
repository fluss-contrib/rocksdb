 ...
 * values consider using {@link io.github.fluss_contrib.rocksdb.DirectSlice}</p>
 */
public class Slice extends AbstractSlice<byte[]> {
   ...
   * {@see io.github.fluss_contrib.rocksdb.RocksObject#disOwnNativeHandle()} is intentionally
