 ...
 * is uint32_t and java io.github.fluss_contrib.rocksdb.TickerType is byte, this causes mapping
 * issues when rocksdb::Tickers value is greater then 127 (0x7F) for jbyte jni interface as range
 * greater is not available. Without breaking interface in minor versions, value mappings for
 * io.github.fluss_contrib.rocksdb.TickerType leverage full byte range [-128 (-0x80), (0x7F)]. Newer
 * tickers added should descend into negative values until TICKER_ENUM_MAX reaches -128 (-0x80).
 */
public enum TickerType {
     ...
     *
     * @return {@link io.github.fluss_contrib.rocksdb.TickerType} instance.
