...
import static io.github.fluss_contrib.rocksdb.util.BufferUtil.CheckBounds;
import static java.nio.charset.StandardCharsets.UTF_8;

import io.github.fluss_contrib.rocksdb.util.Environment;
...
public class RocksDB extends RocksObject {
   ...
   *
   * @param options {@link io.github.fluss_contrib.rocksdb.Options} instance.
   * @param path the path to the rocksdb.
   * @return a {@link RocksDB} instance on success, null if the specified
   *     {@link RocksDB} can not be opened.
   *
   ...
   * </p>
   *
   * @param options {@link io.github.fluss_contrib.rocksdb.DBOptions} instance.
   * @param path the path to the rocksdb.
   * @param columnFamilyDescriptors list of column family descriptors
   * @param columnFamilyHandles will be filled with ColumnFamilyHandle instances
   *     on open.
   ...
   * @return {@link io.github.fluss_contrib.rocksdb.ColumnFamilyHandle} instance.
   *
   * @throws RocksDBException thrown if error happens in underlying
   *    native library.
   */
   ...
   *
   * @param columnFamilyHandle {@link io.github.fluss_contrib.rocksdb.ColumnFamilyHandle}
   *     instance
   *
   * @throws RocksDBException thrown if error happens in underlying
   *    native library.
   ...
   * Set the database entry for "key" to "value".
   *
   * @param writeOpts {@link io.github.fluss_contrib.rocksdb.WriteOptions} instance.
   * @param key the specified key to be inserted.
   * @param value the value associated with the specified key.
   *
   * @throws RocksDBException thrown if error happens in underlying
   ...
   *
   * @param opt {@link io.github.fluss_contrib.rocksdb.ReadOptions} instance.
   ...
   * database.
   *
   * @param columnFamilyHandle {@link io.github.fluss_contrib.rocksdb.ColumnFamilyHandle} instance
   * @param beginKey First key to delete within database (inclusive)
   * @param endKey Last key to delete within database (exclusive)
   *
   * @throws RocksDBException thrown if error happens in underlying native
   ...
   *     {@link io.github.fluss_contrib.rocksdb.ColumnFamilyHandle} instances.
   * @param keys List of keys for which values need to be retrieved.
   * @return List of values for the given list of keys. List will contain
   * null for keys which could not be found.
   *
   ...
   * @param columnFamilyHandleList {@link java.util.List} containing
   *     {@link io.github.fluss_contrib.rocksdb.ColumnFamilyHandle} instances.
   * @return {@link java.util.List} containing {@link io.github.fluss_contrib.rocksdb.RocksIterator}
   *     instances
   *
   * @throws RocksDBException thrown if error happens in underlying
   *    native library.
   ...
   *
   * @param flushOptions {@link io.github.fluss_contrib.rocksdb.FlushOptions} instance.
   * @throws RocksDBException thrown if an error occurs within the native
   *     part of the library.
   */
   ...
   *
   * @return {@link io.github.fluss_contrib.rocksdb.TransactionLogIterator} instance.
   *
   * @throws io.github.fluss_contrib.rocksdb.RocksDBException if iterator cannot be retrieved
   *     from native-side.
   */
