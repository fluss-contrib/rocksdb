...
public interface AdvancedColumnFamilyOptionsInterface<
   ...
   *     {@link io.github.fluss_contrib.rocksdb.CompressionType} instances.
   *
   * @return the reference to the current options.
   */
  ...
  /**
   * <p>Return the currently set {@link io.github.fluss_contrib.rocksdb.CompressionType}
   * per instances.</p>
   *
   * <p>See: {@link #setCompressionPerLevel(java.util.List)}</p>
   *
   * @return list of {@link io.github.fluss_contrib.rocksdb.CompressionType}
   *     instances.
   */
