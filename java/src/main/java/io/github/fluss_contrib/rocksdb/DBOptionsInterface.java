...
public interface DBOptionsInterface<T extends DBOptionsInterface<T>> {
   ...
   *     specified database in {@link RocksDB#open(io.github.fluss_contrib.rocksdb.Options, String)}
   * operation is missing.
   * @return the instance of the current Options
   * @see RocksDB#open(io.github.fluss_contrib.rocksdb.Options, String)
   */
   ...
   * Default: nullptr
   *
   * @param rateLimiter {@link io.github.fluss_contrib.rocksdb.RateLimiter} instance.
   * @return the instance of the current object.
   *
   * @since 3.10.0
   */
   ...
   * @return {@link io.github.fluss_contrib.rocksdb.InfoLogLevel} instance.
   */
