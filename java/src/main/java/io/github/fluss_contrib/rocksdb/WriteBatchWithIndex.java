...
/**
 * Similar to {@link io.github.fluss_contrib.rocksdb.WriteBatch} but with a binary searchable
 * index built for all the keys inserted.
 * <p>
 * Calling put, merge, remove or putLogData calls the same function
 * as with {@link io.github.fluss_contrib.rocksdb.WriteBatch} whilst also building an index.
 * <p>
 * A user can call {@link io.github.fluss_contrib.rocksdb.WriteBatchWithIndex#newIterator()} to
 * create an iterator over the write batch or
 * {@link
 * io.github.fluss_contrib.rocksdb.WriteBatchWithIndex#newIteratorWithBase(io.github.fluss_contrib.rocksdb.RocksIterator)}
...
public class WriteBatchWithIndex extends AbstractWriteBatch {
   ...
   * {@link io.github.fluss_contrib.rocksdb.RocksIteratorInterface#seek(byte[])} to
   ...
   * creating a new Iterator that will use {@link io.github.fluss_contrib.rocksdb.WBWIRocksIterator}
   ...
   *   e.g. {@link io.github.fluss_contrib.rocksdb.RocksDB#newIterator()}
