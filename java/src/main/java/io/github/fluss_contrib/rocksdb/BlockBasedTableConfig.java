...
public class BlockBasedTableConfig extends TableFormatConfig {
   ...
   *
   * @param indexType {@link io.github.fluss_contrib.rocksdb.IndexType} value
   ...
   *
   * @param dataBlockIndexType {@link io.github.fluss_contrib.rocksdb.DataBlockIndexType} value
   * @return the reference to the current option.
   */
   ...
   * Sets
   *
   * @param checksumType {@link io.github.fluss_contrib.rocksdb.ChecksumType} value.
   * @return the reference to the current option.
   */
   ...
   * <p>
   * {@link io.github.fluss_contrib.rocksdb.Cache} should not be disposed before options instances
   * using this cache is disposed.
   * <p>
   * {@link io.github.fluss_contrib.rocksdb.Cache} instance can be re-used in multiple options
   * instances.
   *
   * @param blockCache {@link io.github.fluss_contrib.rocksdb.Cache} Cache java instance
   *     (e.g. LRUCache).
   *
   * @return the reference to the current config.
   */
   ...
   * <p>
   * {@link io.github.fluss_contrib.rocksdb.Filter} should not be closed before options instances
   * using this filter are closed.
   * <p>
   * {@link io.github.fluss_contrib.rocksdb.Filter} instance can be re-used in multiple options
   * instances.
   *
   * @param filterPolicy {@link io.github.fluss_contrib.rocksdb.Filter} Filter Policy java instance.
   * @return the reference to the current config.
   */
   ...
   *
   * @param indexSearchType {@link io.github.fluss_contrib.rocksdb.IndexSearchType} value
   * @return the reference to the current option.
   */
