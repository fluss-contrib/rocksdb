...
import static io.github.fluss_contrib.rocksdb.RocksDB.PERFORMANCE_OPTIMIZATION_FOR_A_VERY_SPECIFIC_WORKLOAD;
 ...
 * {@link OptimisticTransactionDB#beginTransaction(io.github.fluss_contrib.rocksdb.WriteOptions)} or
 * {@link TransactionDB#beginTransaction(io.github.fluss_contrib.rocksdb.WriteOptions)}
 *
...
public class Transaction extends RocksObject {
   ...
   * {@link OptimisticTransactionDB#beginTransaction(io.github.fluss_contrib.rocksdb.WriteOptions)}
   * or {@link TransactionDB#beginTransaction(io.github.fluss_contrib.rocksdb.WriteOptions)}
   *
   ...
   *
   * @param readOptions Read options.
   * @param columnFamilyHandles {@link io.github.fluss_contrib.rocksdb.ColumnFamilyHandle}
   *     instances
  ...
  // TODO(AR) refactor if we implement io.github.fluss_contrib.rocksdb.SliceParts in future
  /**
  ...
  public enum TransactionState {
     ...
     *
     * @return {@link io.github.fluss_contrib.rocksdb.Transaction.TransactionState} instance or
     *     null.
