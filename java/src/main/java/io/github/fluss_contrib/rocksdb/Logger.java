 ...
 *
 * <p>
 * A log level can be set using {@link io.github.fluss_contrib.rocksdb.Options} or
 ...
 * {@link io.github.fluss_contrib.rocksdb.InfoLogLevel#ERROR_LEVEL} or
 * {@link io.github.fluss_contrib.rocksdb.InfoLogLevel#FATAL_LEVEL}.
 * </p>
 */
public abstract class Logger extends RocksCallbackObject implements LoggerInterface {
   ...
   * the {@link io.github.fluss_contrib.rocksdb.Options} instance will be used as
   ...
   *
   * <p><strong>Important:</strong> the log level set within
   * the {@link io.github.fluss_contrib.rocksdb.DBOptions} instance will be used
   * as maximum log level of RocksDB.</p>
   *
   * @param dboptions {@link io.github.fluss_contrib.rocksdb.DBOptions} instance.
   *
   * @deprecated Use {@link Logger#Logger(InfoLogLevel)} instead, e.g. {@code new
