...
#include "include/io_github_fluss_contrib_rocksdb_TtlDB.h"
#include "rocksdb/utilities/db_ttl.h"
#include "rocksjni/cplusplus_to_java_convert.h"
#include "rocksjni/portal.h"

/*
 * Class:     io_github_fluss_contrib_rocksdb_TtlDB
 * Method:    open
 * Signature: (JLjava/lang/String;IZ)J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_TtlDB_open(JNIEnv* env, jclass,
 ...
 */
jlongArray Java_io_github_fluss_1contrib_rocksdb_TtlDB_openCF(
    JNIEnv* env, jclass, jlong jopt_handle, jstring jdb_path,
    jobjectArray jcolumn_names, jlongArray jcolumn_options, jintArray jttls,
    jboolean jread_only) {
  const char* db_path = env->GetStringUTFChars(jdb_path, nullptr);
  if (db_path == nullptr) {
    // exception thrown: OutOfMemoryError
 ...
 * Signature: (J)V
 */
void Java_io_github_fluss_1contrib_rocksdb_TtlDB_disposeInternalJni(
 ...
 * Signature: (J)V
 */
void Java_io_github_fluss_1contrib_rocksdb_TtlDB_closeDatabase(
 ...
 * Signature: (JLio/github/fluss_contrib/rocksdb/ColumnFamilyDescriptor;[BJI)J;
 */
jlong Java_io_github_fluss_1contrib_rocksdb_TtlDB_createColumnFamilyWithTtl(
    JNIEnv* env, jclass, jlong jdb_handle, jbyteArray jcolumn_name,
