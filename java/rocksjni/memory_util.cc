...
#include "include/io_github_fluss_contrib_rocksdb_MemoryUtil.h"
#include "rocksjni/portal.h"

/*
 * Class:     io_github_fluss_contrib_rocksdb_MemoryUtil
 * Method:    getApproximateMemoryUsageByType
 * Signature: ([J[J)Ljava/util/Map;
 */
jobject
Java_io_github_fluss_1contrib_rocksdb_MemoryUtil_getApproximateMemoryUsageByType(
