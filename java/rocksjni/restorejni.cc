...
#include "include/org_fluss_rocksdb_RestoreOptions.h"
#include "rocksdb/utilities/backup_engine.h"
#include "rocksjni/cplusplus_to_java_convert.h"
#include "rocksjni/portal.h"
/*
 * Class:     org_fluss_rocksdb_RestoreOptions
 * Method:    newRestoreOptions
 * Signature: (Z)J
 */
jlong Java_org_fluss_rocksdb_RestoreOptions_newRestoreOptions(
 ...
 * Signature: (J)V
 */
void Java_org_fluss_rocksdb_RestoreOptions_disposeInternalJni(JNIEnv* /*env*/,
                                                              jclass /*jobj*/,
                                                              jlong jhandle) {
