...
#include "include/io_github_fluss_contrib_rocksdb_WriteBatchTest.h"
#include "include/io_github_fluss_contrib_rocksdb_WriteBatchTestInternalHelper.h"
...
/*
 * Class:     io_github_fluss_contrib_rocksdb_WriteBatchTest
 * Method:    getContents
 * Signature: (J)[B
 */
jbyteArray Java_io_github_fluss_1contrib_rocksdb_WriteBatchTest_getContents(
...
/*
 * Class:     io_github_fluss_contrib_rocksdb_WriteBatchTestInternalHelper
 * Method:    setSequence
 * Signature: (JJ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_WriteBatchTestInternalHelper_setSequence(
 ...
 * Signature: (J)J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_WriteBatchTestInternalHelper_sequence(
    JNIEnv* /*env*/, jclass /*jclazz*/, jlong jwb_handle) {
  auto* wb = reinterpret_cast<ROCKSDB_NAMESPACE::WriteBatch*>(jwb_handle);
  assert(wb != nullptr);
 ...
 * Signature: (JJ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_WriteBatchTestInternalHelper_append(
