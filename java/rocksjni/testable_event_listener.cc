...
#include "include/io_github_fluss_contrib_rocksdb_test_TestableEventListener.h"
...
/*
 * Class:     io_github_fluss_contrib_rocksdb_test_TestableEventListener
 * Method:    invokeAllCallbacks
 * Signature: (J)V
 */
void Java_io_github_fluss_1contrib_rocksdb_test_TestableEventListener_invokeAllCallbacks(
