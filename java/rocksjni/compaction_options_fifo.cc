...
#include "include/io_github_fluss_contrib_rocksdb_CompactionOptionsFIFO.h"
#include "rocksdb/advanced_options.h"
#include "rocksjni/cplusplus_to_java_convert.h"

/*
 * Class:     io_github_fluss_contrib_rocksdb_CompactionOptionsFIFO
 * Method:    newCompactionOptionsFIFO
 * Signature: ()J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_CompactionOptionsFIFO_newCompactionOptionsFIFO(
    JNIEnv*, jclass) {
 ...
 * Signature: (JJ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_CompactionOptionsFIFO_setMaxTableFilesSize(
 ...
 * Signature: (J)J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_CompactionOptionsFIFO_maxTableFilesSize(
 ...
 * Signature: (JZ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_CompactionOptionsFIFO_setAllowCompaction(
 ...
 */
jboolean
Java_io_github_fluss_1contrib_rocksdb_CompactionOptionsFIFO_allowCompaction(
    JNIEnv*, jclass, jlong jhandle) {
  auto* opt =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionOptionsFIFO*>(jhandle);
 ...
 * Signature: (JJ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_CompactionOptionsFIFO_setMaxDataFilesSize(
 ...
 * Signature: (J)J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_CompactionOptionsFIFO_maxDataFilesSize(
    JNIEnv*, jclass, jlong jhandle) {
  auto* opt =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionOptionsFIFO*>(jhandle);
 ...
 * Signature: (JZ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_CompactionOptionsFIFO_setUseKvRatioCompaction(
 ...
 */
jboolean
Java_io_github_fluss_1contrib_rocksdb_CompactionOptionsFIFO_useKvRatioCompaction(
    JNIEnv*, jclass, jlong jhandle) {
  auto* opt =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionOptionsFIFO*>(jhandle);
 ...
 * Signature: (J)V
 */
void Java_io_github_fluss_1contrib_rocksdb_CompactionOptionsFIFO_disposeInternalJni(
    JNIEnv*, jclass, jlong jhandle) {
