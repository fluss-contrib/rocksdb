...
#include "include/io_github_fluss_contrib_rocksdb_AbstractCompactionFilterFactory.h"
#include "rocksjni/compaction_filter_factory_jnicallback.h"
#include "rocksjni/cplusplus_to_java_convert.h"

/*
 * Class:     io_github_fluss_contrib_rocksdb_AbstractCompactionFilterFactory
 * Method:    createNewCompactionFilterFactory0
 * Signature: ()J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_AbstractCompactionFilterFactory_createNewCompactionFilterFactory0(
 ...
 * Signature: (J)V
 */
void Java_io_github_fluss_1contrib_rocksdb_AbstractCompactionFilterFactory_disposeInternal(
