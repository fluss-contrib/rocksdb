 ...
 */
jlong Java_org_fluss_rocksdb_AbstractSlice_createNewSliceFromString(
 ...
 * Signature: (J)I
 */
jint Java_org_fluss_rocksdb_AbstractSlice_size0(JNIEnv* /*env*/,
 ...
 * Signature: (J)Z
 */
jboolean Java_org_fluss_rocksdb_AbstractSlice_empty0(JNIEnv* /*env*/,
                                                     jclass /*jcls*/,
                                                     jlong handle) {
  const auto* slice = reinterpret_cast<ROCKSDB_NAMESPACE::Slice*>(handle);
  return slice->empty();
 ...
 */
jstring Java_org_fluss_rocksdb_AbstractSlice_toString0(JNIEnv* env,
                                                       jclass /*jobj*/,
                                                       jlong handle,
                                                       jboolean hex) {
  const auto* slice = reinterpret_cast<ROCKSDB_NAMESPACE::Slice*>(handle);
 ...
 * Signature: (JJ)I;
 */
jint Java_org_fluss_rocksdb_AbstractSlice_compare0(JNIEnv* /*env*/,
                                                   jclass /*jcls*/,
                                                   jlong handle,
                                                   jlong otherHandle) {
  const auto* slice = reinterpret_cast<ROCKSDB_NAMESPACE::Slice*>(handle);
...
jlong Java_org_fluss_rocksdb_Slice_createNewSlice0(JNIEnv* env, jclass /*jcls*/,
  ...
  // NOTE: buf will be deleted in the
  // Java_org_fluss_rocksdb_Slice_disposeInternalBuf method
 ...
 * Signature: (JI)V
 */
void Java_org_fluss_rocksdb_Slice_removePrefix0(JNIEnv* /*env*/,
                                                jclass /*jcls*/, jlong handle,
                                                jint length) {
  auto* slice = reinterpret_cast<ROCKSDB_NAMESPACE::Slice*>(handle);
 ...
 * Signature: (JI)V
 */
void Java_org_fluss_rocksdb_DirectSlice_setLength0(JNIEnv* /*env*/,
                                                   jclass /*jcls*/,
 ...
 * Signature: (JJ)V
 */
void Java_org_fluss_rocksdb_Slice_disposeInternalBuf(
