...
#include "include/io_github_fluss_contrib_rocksdb_CompactionOptions.h"
#include "rocksdb/options.h"
#include "rocksjni/cplusplus_to_java_convert.h"
#include "rocksjni/portal.h"

/*
 * Class:     io_github_fluss_contrib_rocksdb_CompactionOptions
 * Method:    newCompactionOptions
 * Signature: ()J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_CompactionOptions_newCompactionOptions(
    JNIEnv*, jclass) {
 ...
 * Signature: (J)V
 */
void Java_io_github_fluss_1contrib_rocksdb_CompactionOptions_disposeInternalJni(
 ...
 * Signature: (J)B
 */
jbyte Java_io_github_fluss_1contrib_rocksdb_CompactionOptions_compression(
    JNIEnv*, jclass, jlong jhandle) {
  auto* compact_opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionOptions*>(jhandle);
 ...
 * Signature: (JB)V
 */
void Java_io_github_fluss_1contrib_rocksdb_CompactionOptions_setCompression(
 ...
 * Signature: (J)J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_CompactionOptions_outputFileSizeLimit(
    JNIEnv*, jclass, jlong jhandle) {
  auto* compact_opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionOptions*>(jhandle);
 ...
 * Signature: (JJ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_CompactionOptions_setOutputFileSizeLimit(
 ...
 * Signature: (J)I
 */
jint Java_io_github_fluss_1contrib_rocksdb_CompactionOptions_maxSubcompactions(
    JNIEnv*, jclass, jlong jhandle) {
  auto* compact_opts =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionOptions*>(jhandle);
 ...
 * Signature: (JI)V
 */
void Java_io_github_fluss_1contrib_rocksdb_CompactionOptions_setMaxSubcompactions(
