 ...
 * Signature: (J)J
 */
jlong Java_org_fluss_rocksdb_EnvOptions_newEnvOptions__J(JNIEnv*, jclass,
 ...
 * Signature: (JZ)V
 */
void Java_org_fluss_rocksdb_EnvOptions_setUseMmapReads(JNIEnv*, jclass, jlong jhandle,
 ...
 * Signature: (JZ)V
 */
void Java_org_fluss_rocksdb_EnvOptions_setUseMmapWrites(JNIEnv*, jclass,
                                                  jlong jhandle,
 ...
 * Signature: (JZ)V
 */
void Java_org_fluss_rocksdb_EnvOptions_setUseDirectReads(JNIEnv*, jclass,
                                                   jlong jhandle,
 ...
 * Signature: (JZ)V
 */
void Java_org_fluss_rocksdb_EnvOptions_setAllowFallocate(JNIEnv*, jclass,
                                                   jlong jhandle,
 ...
 * Signature: (JZ)V
 */
void Java_org_fluss_rocksdb_EnvOptions_setSetFdCloexec(JNIEnv*, jclass, jlong jhandle,
 ...
 * Signature: (JJ)V
 */
void Java_org_fluss_rocksdb_EnvOptions_setBytesPerSync(JNIEnv*, jclass, jlong jhandle,
 ...
 * Signature: (J)J
 */
jlong Java_org_fluss_rocksdb_EnvOptions_bytesPerSync(JNIEnv*, jclass, jlong jhandle) {
 ...
 * Signature: (J)Z
 */
jboolean Java_org_fluss_rocksdb_EnvOptions_fallocateWithKeepSize(JNIEnv*, jclass,
                                                           jlong jhandle) {
 ...
 * Signature: (J)J
 */
jlong Java_org_fluss_rocksdb_EnvOptions_writableFileMaxBufferSize(JNIEnv*, jclass,
                                                            jlong jhandle) {
 ...
 * Signature: (JJ)V
 */
void Java_org_fluss_rocksdb_EnvOptions_setRateLimiter(JNIEnv*, jclass, jlong jhandle,
                                                jlong rl_handle) {
