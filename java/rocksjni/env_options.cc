...
#include "include/io_github_fluss_contrib_rocksdb_EnvOptions.h"
...
/*
 * Class:     io_github_fluss_contrib_rocksdb_EnvOptions
 * Method:    newEnvOptions
 * Signature: ()J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_EnvOptions_newEnvOptions__(JNIEnv*,
                                                                       jclass) {
 ...
 * Signature: (J)J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_EnvOptions_newEnvOptions__J(
 ...
 * Signature: (J)V
 */
void Java_io_github_fluss_1contrib_rocksdb_EnvOptions_disposeInternalJni(
 ...
 * Signature: (JZ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_EnvOptions_setUseMmapReads(
    JNIEnv*, jclass, jlong jhandle, jboolean use_mmap_reads) {
 ...
 * Signature: (J)Z
 */
jboolean Java_io_github_fluss_1contrib_rocksdb_EnvOptions_useMmapReads(
    JNIEnv*, jclass, jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_EnvOptions_setUseMmapWrites(
 ...
 * Signature: (J)Z
 */
jboolean Java_io_github_fluss_1contrib_rocksdb_EnvOptions_useMmapWrites(
    JNIEnv*, jclass, jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_EnvOptions_setUseDirectReads(
 ...
 * Signature: (J)Z
 */
jboolean Java_io_github_fluss_1contrib_rocksdb_EnvOptions_useDirectReads(
    JNIEnv*, jclass, jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_EnvOptions_setUseDirectWrites(
 ...
 * Signature: (J)Z
 */
jboolean Java_io_github_fluss_1contrib_rocksdb_EnvOptions_useDirectWrites(
    JNIEnv*, jclass, jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_EnvOptions_setAllowFallocate(
    JNIEnv*, jclass, jlong jhandle, jboolean allow_fallocate) {
 ...
 * Signature: (J)Z
 */
jboolean Java_io_github_fluss_1contrib_rocksdb_EnvOptions_allowFallocate(
    JNIEnv*, jclass, jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_EnvOptions_setSetFdCloexec(
    JNIEnv*, jclass, jlong jhandle, jboolean set_fd_cloexec) {
 ...
 * Signature: (J)Z
 */
jboolean Java_io_github_fluss_1contrib_rocksdb_EnvOptions_setFdCloexec(
    JNIEnv*, jclass, jlong jhandle) {
 ...
 * Signature: (JJ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_EnvOptions_setBytesPerSync(
 ...
 * Signature: (J)J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_EnvOptions_bytesPerSync(
    JNIEnv*, jclass, jlong jhandle) {
 ...
 * Signature: (JZ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_EnvOptions_setFallocateWithKeepSize(
 ...
 * Signature: (J)Z
 */
jboolean Java_io_github_fluss_1contrib_rocksdb_EnvOptions_fallocateWithKeepSize(
    JNIEnv*, jclass, jlong jhandle) {
 ...
 * Signature: (JJ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_EnvOptions_setCompactionReadaheadSize(
 ...
 * Signature: (J)J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_EnvOptions_compactionReadaheadSize(
    JNIEnv*, jclass, jlong jhandle) {
 ...
 * Signature: (JJ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_EnvOptions_setWritableFileMaxBufferSize(
 ...
 * Signature: (J)J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_EnvOptions_writableFileMaxBufferSize(
    JNIEnv*, jclass, jlong jhandle) {
 ...
 * Signature: (JJ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_EnvOptions_setRateLimiter(
    JNIEnv*, jclass, jlong jhandle, jlong rl_handle) {
