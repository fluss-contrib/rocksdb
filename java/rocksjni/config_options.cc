...
#include "include/io_github_fluss_contrib_rocksdb_ConfigOptions.h"
#include "rocksdb/convenience.h"
#include "rocksjni/cplusplus_to_java_convert.h"
#include "rocksjni/portal.h"

/*
 * Class:     io_github_fluss_contrib_rocksdb_ConfigOptions
 * Method:    disposeInternal
 * Signature: (J)V
 */
void Java_io_github_fluss_1contrib_rocksdb_ConfigOptions_disposeInternalJni(
 ...
 * Signature: ()J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_ConfigOptions_newConfigOptions(
    JNIEnv*, jclass) {
 ...
 * Signature: (JJ;)V
 */
void Java_io_github_fluss_1contrib_rocksdb_ConfigOptions_setEnv(
    JNIEnv*, jclass, jlong handle, jlong rocksdb_env_handle) {
 ...
 */
void Java_io_github_fluss_1contrib_rocksdb_ConfigOptions_setDelimiter(
 ...
 * Signature: (JZ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_ConfigOptions_setIgnoreUnknownOptions(
    JNIEnv*, jclass, jlong handle, jboolean b) {
  auto* cfg_opt = reinterpret_cast<ROCKSDB_NAMESPACE::ConfigOptions*>(handle);
 ...
 * Signature: (JZ)V
 */
void Java_io_github_fluss_1contrib_rocksdb_ConfigOptions_setInputStringsEscaped(
    JNIEnv*, jclass, jlong handle, jboolean b) {
  auto* cfg_opt = reinterpret_cast<ROCKSDB_NAMESPACE::ConfigOptions*>(handle);
 ...
 * Signature: (JI)V
 */
void Java_io_github_fluss_1contrib_rocksdb_ConfigOptions_setSanityLevel(
    JNIEnv*, jclass, jlong handle, jbyte level) {
  auto* cfg_opt = reinterpret_cast<ROCKSDB_NAMESPACE::ConfigOptions*>(handle);
