...
#include "include/io_github_fluss_contrib_rocksdb_AbstractTraceWriter.h"
#include "rocksjni/cplusplus_to_java_convert.h"
#include "rocksjni/trace_writer_jnicallback.h"

/*
 * Class:     io_github_fluss_contrib_rocksdb_AbstractTraceWriter
 * Method:    createNewTraceWriter
 * Signature: ()J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_AbstractTraceWriter_createNewTraceWriter(
