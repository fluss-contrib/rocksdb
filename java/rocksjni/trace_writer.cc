...
#include "include/org_fluss_rocksdb_AbstractTraceWriter.h"
#include "rocksjni/cplusplus_to_java_convert.h"
#include "rocksjni/trace_writer_jnicallback.h"

/*
 * Class:     org_fluss_rocksdb_AbstractTraceWriter
 * Method:    createNewTraceWriter
 * Signature: ()J
 */
jlong Java_org_fluss_rocksdb_AbstractTraceWriter_createNewTraceWriter(JNIEnv* env,
                                                                jobject jobj) {
