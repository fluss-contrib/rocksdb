...
#include "include/io_github_fluss_contrib_rocksdb_BlockBasedTableConfig.h"
#include "include/io_github_fluss_contrib_rocksdb_PlainTableConfig.h"
#include "portal.h"
...
/*
 * Class:     io_github_fluss_contrib_rocksdb_PlainTableConfig
 * Method:    newTableFactoryHandle
 * Signature: (IIDIIBZZ)J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_PlainTableConfig_newTableFactoryHandle(
...
/*
 * Class:     io_github_fluss_contrib_rocksdb_BlockBasedTableConfig
 * Method:    newTableFactoryHandle
 * Signature: (ZZZZBBDBZJJJIIIJZZZJZZIIZZJJBBJI)J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_BlockBasedTableConfig_newTableFactoryHandle(
