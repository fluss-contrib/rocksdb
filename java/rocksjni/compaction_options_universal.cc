 ...
 * Signature: (J)I
 */
jint Java_org_fluss_rocksdb_CompactionOptionsUniversal_sizeRatio(JNIEnv*, jclass,
                                                           jlong jhandle) {
  auto* opt =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionOptionsUniversal*>(jhandle);
 ...
 * Signature: (J)I
 */
jint Java_org_fluss_rocksdb_CompactionOptionsUniversal_minMergeWidth(JNIEnv*, jclass,
                                                               jlong jhandle) {
  auto* opt =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionOptionsUniversal*>(jhandle);
 ...
 * Signature: (J)I
 */
jint Java_org_fluss_rocksdb_CompactionOptionsUniversal_maxMergeWidth(JNIEnv*, jclass,
                                                               jlong jhandle) {
  auto* opt =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionOptionsUniversal*>(jhandle);
 ...
 * Signature: (J)B
 */
jbyte Java_org_fluss_rocksdb_CompactionOptionsUniversal_stopStyle(JNIEnv*, jclass,
                                                            jlong jhandle) {
  auto* opt =
      reinterpret_cast<ROCKSDB_NAMESPACE::CompactionOptionsUniversal*>(jhandle);
