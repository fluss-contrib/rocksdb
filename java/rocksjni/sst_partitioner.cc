...
#include "include/io_github_fluss_contrib_rocksdb_SstPartitionerFixedPrefixFactory.h"
#include "rocksdb/sst_file_manager.h"
#include "rocksjni/cplusplus_to_java_convert.h"
#include "rocksjni/portal.h"

/*
 * Class:     io_github_fluss_contrib_rocksdb_SstPartitionerFixedPrefixFactory
 * Method:    newSstPartitionerFixedPrefixFactory0
 * Signature: (J)J
 */
jlong Java_io_github_fluss_1contrib_rocksdb_SstPartitionerFixedPrefixFactory_newSstPartitionerFixedPrefixFactory0(
 ...
 * Signature: (J)V
 */
void Java_io_github_fluss_1contrib_rocksdb_SstPartitionerFixedPrefixFactory_disposeInternalJni(
