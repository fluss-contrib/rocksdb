...
#include "include/io_github_fluss_contrib_rocksdb_ThreadStatus.h"
#include "portal.h"

/*
 * Class:     io_github_fluss_contrib_rocksdb_ThreadStatus
 * Method:    getThreadTypeName
 * Signature: (B)Ljava/lang/String;
 */
jstring Java_io_github_fluss_1contrib_rocksdb_ThreadStatus_getThreadTypeName(
 ...
 * Signature: (B)Ljava/lang/String;
 */
jstring Java_io_github_fluss_1contrib_rocksdb_ThreadStatus_getOperationName(
 ...
 */
jstring Java_io_github_fluss_1contrib_rocksdb_ThreadStatus_microsToStringNative(
 ...
 */
jstring
Java_io_github_fluss_1contrib_rocksdb_ThreadStatus_getOperationStageName(
 ...
 */
jstring
Java_io_github_fluss_1contrib_rocksdb_ThreadStatus_getOperationPropertyName(
 ...
 */
jobject
Java_io_github_fluss_1contrib_rocksdb_ThreadStatus_interpretOperationProperties(
    JNIEnv* env, jclass, jbyte joperation_type_value,
 ...
 * Signature: (B)Ljava/lang/String;
 */
jstring Java_io_github_fluss_1contrib_rocksdb_ThreadStatus_getStateName(
