...
```bash
$ mvn install:install-file -Dfile=./java/target/rocksdbjni-8.11.0-SNAPSHOT-osx.jar -DgroupId=io.github.fluss-contrib -DartifactId=fluss-rocksdbjni -Dversion=8.11.0-SNAPSHOT -Dpackaging=jar
```
